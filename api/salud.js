  ...
  <div style="padding:28px 32px">
    ...
    <p style="font-size:12px;color:#94a3b8;text-align:center">Tu opinión es confidencial y nos ayuda a mejorar el servicio.</p>
      ...
      if (accion === 'charla') {
        ...
        const data = await query('evaluaciones_charla', 'POST', { ts: new Date().toISOString(), p1:vals[0], p2:vals[1], p3:vals[2], codigo: codigo||null, nombre: nombre||null, sesion_id: sesion_id || null, titulo: titulo || null });
